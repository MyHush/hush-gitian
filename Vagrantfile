...
Vagrant.configure(2) do |config|
  ...
  config.vm.define 'hush-build', autostart: false do |gitian|
...
#    gitian.vm.synced_folder "./hush-binaries", "/home/vagrant/hush-binaries", create: true
    gitian.vm.post_up_message = "Hush deterministic build environment started."
  end
